    ...
    \begin{multicols}{2}
        ...
        % ability.
            ...
            \subsection{Cohesion}
                ...
                One example of high cohesion is the \codeword{IOSystem} and the classes which implement it (see \autoref{fig:io-system}).
                
                The first implementation I made was StandardIO (see \autoref{fig:standard-io}) which passes these methods through to \codeword{System.out/in}. One benefit of this is that I can easily slot in additional processing layers, such as \codeword{LocalisedIO} (see \autoref{fig:localised-io}) which can take in data, process it and pass it through to an arbitrary \codeword{IOSystem}.
